	 ...
	 <div id="wrapper">
        ...
        <div id="page-wrapper">
			 <div class="row">
                ...
                <div class="col-lg-12">
                    <h3 class="page-header">Paper details</h3>
                </div>
                <!-- /.col-lg-12 -->
           </div>
			<div class="row">  
...
$id = $_POST["doc_id"];
$sub = $_POST["doc_sub"];
$despacth_dt = $_POST["doc_despatch_dt"];


$sql = "SELECT * from paper_master_info where paper_ref_id = '$id' OR paper_sub = '$sub' OR paper_despatch_dt = '$despacth_dt'";
...
if (mysqli_num_rows($result) > 0) 
{
      ...
      $id = $row['paper_ref_id'];
        ...
        <form role="form" action="paper_details.php?id=<?php echo $id ?>" method="POST">
        <tr>
			<td><?php echo $s_no; ?></td>
